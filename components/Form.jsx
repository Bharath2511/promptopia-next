    ...
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <form className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
        ...
        <div className='flex-end mx-3 mb-5 gap-4'>
          ...
          <button type='submit' disabled={submitting} onClick={handleSubmit} className='px-5 py-1.5 text-sm bg-primary-orange rounded-full text-white'>{submitting ? `${type}..` : type}</button>
        </div>
      </form>
    </section>
  )
